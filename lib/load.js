const begin = (d, s, t) => `BEGIN name t_${d}.${s}.${t};`;
...
const load = async (opts) => {
    ...
    try {
        await snow.execute(begin(opts.database, opts.schema, opts.table));
